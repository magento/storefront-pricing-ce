...
<!---
    If relevant, please provide a list of fixed issues in the format magento-commerce/storefront-pricing-ce#<issue_number>.
    There could be 1 or more issues linked here and it will help us find some more information about the reasoning behind this change.
-->
1. Fixes magento-commerce/storefront-pricing-ce#<issue_number>
