 ...
 */
final class PriceBookStatusResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookStatusResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(PriceBookStatusResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
                $dto->setStatus(
