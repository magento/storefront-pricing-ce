...
final class ScopeMapper
{
     ...
     * @var string
     */
    private static $dtoClassName = ScopeInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(Scope $dto, string $key, $value): void
    {
        switch ($key) {
            case "website":
                $dto->setWebsite((array) $value);
                break;
            case "customer_group":
                $dto->setCustomerGroup((array) $value);
                break;
        }
    }
}
