 ...
 */
final class GetPricesRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = GetPricesRequestInterface::class;
    ...
    * would be built
    *
    * @param GetPricesRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(GetPricesRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "price_book_id":
