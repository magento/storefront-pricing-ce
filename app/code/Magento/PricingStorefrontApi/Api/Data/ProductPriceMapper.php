...
final class ProductPriceMapper
{
     ...
     * @var string
     */
    private static $dtoClassName = ProductPriceInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ProductPrice $dto, string $key, $value): void
    {
        switch ($key) {
            case "entity_id":
            ...
            case "minimum_price":
                $dto->setMinimumPrice(
                    $this->objectManager
                       ->create(\Magento\PricingStorefrontApi\Api\Data\PriceMapper::class)
                       ->setData($value)
                       ->build()
                );
                break;
