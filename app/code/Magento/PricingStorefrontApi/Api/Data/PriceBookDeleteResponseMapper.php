 ...
 */
final class PriceBookDeleteResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookDeleteResponseInterface::class;
    ...
    * would be built
    *
    * @param PriceBookDeleteResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(PriceBookDeleteResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
                $dto->setStatus(
