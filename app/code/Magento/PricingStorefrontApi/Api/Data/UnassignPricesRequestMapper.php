 ...
 */
final class UnassignPricesRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = UnassignPricesRequestInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(UnassignPricesRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "ids":
