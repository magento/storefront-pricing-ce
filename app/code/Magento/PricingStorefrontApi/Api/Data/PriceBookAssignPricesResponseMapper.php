 ...
 */
final class PriceBookAssignPricesResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookAssignPricesResponseInterface::class;
    ...
    * would be built
    *
    * @param PriceBookAssignPricesResponse $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(PriceBookAssignPricesResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
                $dto->setStatus(
