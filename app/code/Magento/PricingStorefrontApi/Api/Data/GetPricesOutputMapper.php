 ...
 */
final class GetPricesOutputMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = GetPricesOutputInterface::class;
    ...
    * would be built
    *
    * @param GetPricesOutput $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(GetPricesOutput $dto, string $key, $value): void
    {
        switch ($key) {
            case "prices":
                $convertedArray = [];
