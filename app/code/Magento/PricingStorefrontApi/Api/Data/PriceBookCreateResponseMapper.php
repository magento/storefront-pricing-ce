 ...
 */
final class PriceBookCreateResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookCreateResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(PriceBookCreateResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "price_book":
                $dto->setPriceBook(
                    $this->objectManager
                       ->create(\Magento\PricingStorefrontApi\Api\Data\PriceBookMapper::class)
                       ->setData($value)
                       ->build()
                );
                break;
            case "status":
                $dto->setStatus(
                    $this->objectManager
                       ->create(\Magento\PricingStorefrontApi\Api\Data\StatusMapper::class)
                       ->setData($value)
                       ->build()
                );
                break;
