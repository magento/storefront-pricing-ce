 ...
 */
final class PriceBookRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookRequestInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(PriceBookRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "price_book":
                $dto->setPriceBook(
