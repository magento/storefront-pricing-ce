 ...
 */
final class PriceBookUnassignPricesResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookUnassignPricesResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(PriceBookUnassignPricesResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "status":
                $dto->setStatus(
