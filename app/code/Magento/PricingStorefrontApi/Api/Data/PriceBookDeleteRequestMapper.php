 ...
 */
final class PriceBookDeleteRequestMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookDeleteRequestInterface::class;
    ...
    * would be built
    *
    * @param PriceBookDeleteRequest $dto
    * @param string $key
    * @param mixed $value
    */
    private function setByKey(PriceBookDeleteRequest $dto, string $key, $value): void
    {
        switch ($key) {
            case "id":
