 ...
 */
final class PriceBookResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = PriceBookResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(PriceBookResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "price_book":
                $dto->setPriceBook(
