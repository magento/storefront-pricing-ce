...
class PriceBookService implements PriceBookServiceInterface
{
     ...
     *
     * @param PriceBookCreateRequestInterface $value
     * @return PriceBookCreateRequest
     */
    private function createPriceBookToProto(PriceBookCreateRequestInterface $value): PriceBookCreateRequest
    {
        // convert data from \Magento\PricingStorefrontApi\Api\Data\PriceBookCreateRequest
        // to \Magento\PricingStorefrontApi\Proto\PriceBookCreateRequest
        /** @var \Magento\PricingStorefrontApi\Api\Data\PriceBookCreateRequest $value **/
        $p = function () use ($value) {
            $r = new \Magento\PricingStorefrontApi\Proto\PriceBookCreateRequest();
            ...
            if ($prop3 !== null) {
                // convert data from \Magento\PricingStorefrontApi\Api\Data\Scope
                // to \Magento\PricingStorefrontApi\Proto\Scope
                /** @var \Magento\PricingStorefrontApi\Api\Data\Scope $prop3 **/
     ...
     * phpcs:disable Generic.Metrics.NestingLevel.TooHigh
     */
    private function createPriceBookFromProto(PriceBookResponse $value): PriceBookResponseInterface
    {
        // convert data from \Magento\PricingStorefrontApi\Proto\PriceBookResponse
        // to \Magento\PricingStorefrontApi\Api\Data\PriceBookResponse
        /** @var \Magento\PricingStorefrontApi\Proto\PriceBookResponse $value **/
     ...
     * Autogenerated description for deletePriceBook method
     *
     * @param PriceBookStatusResponse $value
     * @return PriceBookStatusResponseInterface
     * phpcs:disable Generic.Metrics.NestingLevel.TooHigh
     */
    private function deletePriceBookFromProto(PriceBookStatusResponse $value): PriceBookStatusResponseInterface
    {
        // convert data from \Magento\PricingStorefrontApi\Proto\PriceBookStatusResponse
        // to \Magento\PricingStorefrontApi\Api\Data\PriceBookStatusResponse
        /** @var \Magento\PricingStorefrontApi\Proto\PriceBookStatusResponse $value **/
        $p = function () use ($value) {
            $r = new \Magento\PricingStorefrontApi\Api\Data\PriceBookStatusResponse();
     ...
     * phpcs:disable Generic.Metrics.NestingLevel.TooHigh
     */
    private function assignPricesFromProto(PriceBookStatusResponse $value): PriceBookStatusResponseInterface
    {
        // convert data from \Magento\PricingStorefrontApi\Proto\PriceBookStatusResponse
        // to \Magento\PricingStorefrontApi\Api\Data\PriceBookStatusResponse
        /** @var \Magento\PricingStorefrontApi\Proto\PriceBookStatusResponse $value **/
     ...
     * phpcs:disable Generic.Metrics.NestingLevel.TooHigh
     */
    private function unassignPricesFromProto(PriceBookStatusResponse $value): PriceBookStatusResponseInterface
    {
        // convert data from \Magento\PricingStorefrontApi\Proto\PriceBookStatusResponse
        // to \Magento\PricingStorefrontApi\Api\Data\PriceBookStatusResponse
        /** @var \Magento\PricingStorefrontApi\Proto\PriceBookStatusResponse $value **/
